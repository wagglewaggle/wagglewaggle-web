...
const CustomButton = styled('div', {
  ...
  alignItems: 'center',
  borderTopLeftRadius: variant === 'list' ? 4 : 0,
  borderBottomLeftRadius: variant === 'list' ? 4 : 0,
  borderTopRightRadius: variant === 'list' ? 0 : 4,
  borderBottomRightRadius: variant === 'list' ? 0 : 4,
  width: 40,
  height: 40,
