  ...
  return (
    ...
    >
      ...
      <ContentWrap>
        ...
        <SubTitle>제7조(행태정보의 수집·이용·제공 및 거부 등에 관한 사항)</SubTitle>
        <Content>
          ① 행태정보의 수집·이용·제공 및 거부등에 관한 사항 Team EXIT은 온라인 맞춤형 광고 등을 위한
          행태정보를 수집·이용·제공하지 않습니다.
        </Content>
        <SubTitle>제8조(추가적인 이용·제공 판단기준)</SubTitle>
        <Content>
        ...
        <SubTitle>제9조(가명정보를 처리하는 경우 가명정보 처리에 관한 사항)</SubTitle>
        ...
        />
        <SubTitle>제10조(개인정보 보호책임자에 관한 사항)</SubTitle>
        <Content>
        ...
        <SubTitle>제11조(개인정보의 열람청구를 접수·처리하는 부서)</SubTitle>
        <Content>
